    ...
    var stackGlowFilter = Blockly.utils.createSvgElement('filter',
        {
            ...
            'height': '160%', 'width': '180%', y: '-30%', x: '-40%'
        }, defs);
    ...
    Blockly.utils.createSvgElement('feFlood',
        {
            ...
            'flood-opacity': Blockly.Colours.stackGlowOpacity, 'result': 'outColor'
        }, stackGlowFilter);
    Blockly.utils.createSvgElement('feComposite',
        {
    ...
    Blockly.utils.createSvgElement('feFlood',
        {
            ...
            'flood-opacity': Blockly.Colours.replacementGlowOpacity, 'result': 'outColor'
        }, replacementGlowFilter);
    Blockly.utils.createSvgElement('feComposite',
        {
            'in': 'outColor', 'in2': 'outBlur',
